        ...
        <section id="hero" className="relative min-h-screen flex items-center overflow-hidden bg-mesh pt-20 pb-12">
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 py-8 w-full">
                ...
                <div className="flex flex-col items-center text-center space-y-8">
                    ...
                    {/* Badge */}
                    <div className="inline-flex items-center gap-2 px-4 py-2.5 rounded-full bg-surface-secondary/80 backdrop-blur-md border border-primary-100 shadow-sm">
                    ...
                    {/* Description */}
                    <p className="text-base sm:text-lg md:text-xl text-text-secondary leading-relaxed max-w-2xl px-4">
                    ...
                    {/* Stats */}
                    <div className="flex justify-center gap-8 sm:gap-12 mt-8 pt-8 border-t border-border-light w-full max-w-md">
                        {[
                            { value: '20+', label: 'Anos' },
